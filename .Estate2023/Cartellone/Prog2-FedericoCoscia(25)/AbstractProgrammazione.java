...
/**
 * Classe astratta rappresentante una Programmazione caratterizata dal suo
 * giorno iniziale,
...
public abstract class AbstractProgrammazione implements Programmazione {
    ...
    /**
     * Costruisce una Programmazione, definita a partire dal giorno iniziale
     * specificato.
     * 
     * @throws IllegalArgumentException se giornoIniziale è minore di 1, o maggiore
     *                                  di 31
     */
     AbstractProgrammazione(int giornoIniziale) {
        if ((giornoIniziale < 1) || (giornoIniziale > 31))
            throw new IllegalArgumentException(
                    "Il giorno iniziale di una Programmazione non può essere < 1 o > 31 - Found: " + giornoIniziale);
